---
title: 'Today’s education, tomorrow’s fine generation'
status: 'published'
author: 'Justin'
slug: 'today-s-education-tomorrow-s-fine-generation'
description: 'I recently read a very interesting article about state funded schools adapting...'
image: '/images/blog/today-s-education-tomorrow-s-fine-generation-cover.webp'
...
Unlike a lot of UK based systems, the IB does not focus on one single world view or history within its subjects, but is instead much more globally minded, thus creating more globally rounded and internationally minded students.

![south-bank-international](https://res.cloudinary.com/dpgowkqsr/image/upload/v1611946280/Picture3_9f0007ffe3.jpg)
...
[Here](https://southbank.org)’s more on what the school program has to offer.
