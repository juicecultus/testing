---
title: 'Date or date not, there is no try'
status: 'published'
author: 'Justin'
slug: 'date-or-date-not-there-is-no-try'
description: 'As a new and first time dad, I’ve learnt the hard way that the life of a parent is mainly...'
image: '/images/blog/date-or-date-not-there-is-no-try-cover.webp'
